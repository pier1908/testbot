...
if (six.PY2):
    ...
    import urllib.parse
acil = PRANKBOTS.LINE()
acil.login(token="ErANgwoQ6IuuKenc89B6.REewN+Nk/mQ9YCqnNxEEPG.D1HAsuT9SEkkaFFEdkzTb15IX90h1gNkuqVg9kasnTo=")
acil.loginResult()
ki = PRANKBOTS.LINE()
ki.login(token="ErS1cbUNTTwBZgcjZe4b.mn+pyx0EVgBISt160mxx6W.4CCKLFt47GYH1/RgCeH1QYWlpEIAwxcA/qxghEOop8g=")
ki.loginResult()
ki2= PRANKBOTS.LINE()
ki2.login(token="ErFSI8gNavAfUjGF4KS4.MScy77KOt9Zly64u9SjV5a.F+tI6cjZGrvdxkOwMFEnOZ4V7qMrmN8mszMAxrrouYo=")
ki2.loginResult()
ki3 = PRANKBOTS.LINE()
ki3.login(token="Er5dD3aMG5ywz2joSeV4.syyEZnWpSETxuIg/JPXwba.A6XokYrznByNofse2z9ckdXyRb5AJ5cy6VH5nItGodg=")
ki3.loginResult()
ki4 = PRANKBOTS.LINE()
ki4.login(token="Er08GoHFxE6aiXLl5wXb.hO5UZC0PQgE/IjKWfGEWcW.gfzwCCJ6SFklVmTD50b8LgsFwB4Cz2NrU7pqqekAydQ=")
ki4.loginResult()
ki5 = PRANKBOTS.LINE()
ki5.login(token="ErmoVj6Ct2EPx2dW5GW0.7CWXB4d3AwD/cNd9dSzDia.jxOhrZBT7Y6xr+FNtVlh1sDUKgB7bSnaaluHfyZ7Gpc=")
ki5.loginResult()
ki6 = PRANKBOTS.LINE()
ki6.login(token="EreX61khAdxR0mVHT0H4.E4+Ml938/2ScOH18gx7q9a.Z6LW5rGHs1juPFNp77oCCc4hKsswBQx6fWJBCLvhWNU=")
ki6.loginResult()
ki7 = PRANKBOTS.LINE()
ki7.login(token="ErBpgUiUaDNgaNqYVhId.VZUGcP5yCzKa6St6e0jK3q.DlaNuUpdhohDmKegbCru/G3dSVkzAgqF9JbDr348Kwk=")
ki7.loginResult()
ki8 = PRANKBOTS.LINE()
ki8.login(token="ErBM8DmDVuuUkELuUG7e.Ph/7tPaqd69/8I2m5j1sxG.scj70/l3sEK2Du0TwOTeHLxTnodjibGs/7xkiWVpbG4=")
ki8.loginResult()
ki9 = PRANKBOTS.LINE()
ki9.login(token="ErHk2t0fQvKz9Q2lcoV7.Fu7VpB0jqFv2XyP5uu1oXW.XHZsCtRmrpxgTrKh8Tr4U/EsiE5OBbPm/DYFg0cvIC8=")
ki9.loginResult()
ki10 = PRANKBOTS.LINE()
ki10.login(token="ErXq2SwRxaEFhZYoOVl2.t3F//emgqn/RctqV82RouG.CiCv8znZuLM156bW8gYMS15MZYQEkZ/F0mISo/zyiBQ=")
ki10.loginResult()
print "login success"
reload(sys)
...
admsa = "uade1169ff9caf8cabdc9c40d9d779ea6"
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':False,
    'autoAdd':True,
    'tagme':"kenapa tag saya kalo perlu vc aja",
    'sider1':"Hai gak usah ngintip,,nanti bintitan kk",
    'joingc':"Selamat datang semoga betah digrup kami",
    'leftgc':"Terimakasih sudah mampir digrup kami",
    "stickerMention":False,
    'message':"""THANKS FOR ADD MEQ""",
    "lang":"JP",
...
#----------------------------------------------
		    ...
		    a = msg.text.replace("Xvideos ","")
                ...
                ki.sendText(msg.to,"ALL MODE ON")
            elif "B1" == msg.text:
                msg.contentType = 13
                msg.contentMetadata = {'mid': kimid}
                ki.sendMessage(msg)
...
#=====================================================================================   
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'uc9b4a1fb9b0de4dd27b02ea5629488c9'}
                acil.sendText(msg.to,"❂•••••••••✧••••••••••❂")
                acil.sendMessage(msg)
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'uc9b4a1fb9b0de4dd27b02ea5629488c9'}
                ...
                if c in [""," ","\n",None]:
                    acil.sendText(msg.to,"hayo ngapain ngintip doang.. ntr bintitan kapok✔")
                else:
                    wait["sider1"] = c
                    acil.sendText(msg.to,"✨This has been changed✨\n\n" + c)
